<section id="features" data-aos="flip-up">
        ...
        <div class="body">
            ...
            <div class="right-features" data-animate="bounceIn" data-offset="50" data-duration="1.0s" data-delay="0.1s">
                <a href="downloadReel.php">    
                    <div class="download-reels f-r">
                        <div class="image">
                            <div class="image-a">
                                <img src="assets/images/instagram-reels.png" alt="">
                            </div>
                        </div>
                        <div class="content">
                            <div class="head">
                ...
                <a href="downloadVideo.php">
                    <div class="download-videos f-r">
                        <div class="image">
                            <div class="image-a">
                ...
                <a href="downloadIgtv.php">
                    <div class="download-igtv f-r">
                        <div class="image">
                            <div class="image-a">
                                <img src="assets/images/igtv.png" alt="">
                            </div>
                        </div>
                        <div class="content">
                            <div class="head">
